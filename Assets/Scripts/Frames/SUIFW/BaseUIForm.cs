...
namespace SUIFW
{
	public class BaseUIForm : MonoBehaviour {
        /*字段*/
        [SerializeField] private UIType _CurrentUIType=new UIType();
        [SerializeField] private Action<bool> _UpdateView;
	    ...
	    public virtual void Display()
	    {
            ...
            if (_UpdateView != null) _UpdateView(true);
	    }
	    ...
	    public virtual void Redisplay()
	    {
            ...
            if (_UpdateView != null) _UpdateView(false);
        }
